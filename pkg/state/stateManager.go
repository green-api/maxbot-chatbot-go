...
type StateManager interface {
	...
	GetStateData(stateId string) map[string]any
	SetStateData(stateId string, stateData map[string]any)
	UpdateStateData(stateId string, stateData map[string]any)
...
func NewMapStateManager(initData map[string]any) *MapStateManager {
...
func (sm *MapStateManager) Get(stateId string) State {
	if state, exist := sm.states[stateId]; exist {
		return state
	}
	return nil
}
...
func (sm *MapStateManager) GetStateData(stateId string) map[string]any {
...
func (sm *MapStateManager) SetStateData(stateId string, newStateData map[string]any) {
	state := sm.Get(stateId)
	if state != nil {
...
func (sm *MapStateManager) UpdateStateData(stateId string, newStateData map[string]any) {
	state := sm.Get(stateId)
	if state != nil {
